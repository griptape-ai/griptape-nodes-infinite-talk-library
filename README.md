...
1. Copy the path to your `griptape-nodes-library.json` file within the `griptape_nodes_infinite_talk_library` directory. Right click on the file, and `Copy Path` (Not `Copy Relative Path`).
